...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**validateLoanEligibility**](docs/DefaultApi.md#validateLoanEligibility) | **POST** /api/loan-eligibility | Validate loan eligibility


## Documentation for Models

 - [LoanValidationRequest](docs/LoanValidationRequest.md)
 - [LoanValidationResponse](docs/LoanValidationResponse.md)
