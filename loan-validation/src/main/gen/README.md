...
Loan Validation API
- API version: 1.0.0
  - Build date: 2025-09-10T18:08:51.864200200-05:00[America/Lima]
...
------------ | ------------- | ------------- | -------------
*LoanValidationsApi* | [**validateLoan**](docs/LoanValidationsApi.md#validateLoan) | **POST** /loan-validations | Valida un préstamo


## Documentation for Models

 - [LoanValidationRequest](docs/LoanValidationRequest.md)
 - [LoanValidationResult](docs/LoanValidationResult.md)
